...
- [Server-Side Data](/docs/tutorials/server-side-data) - Load data from a backend
- [How-to: Filtering](/docs/how-to/filtering) - Filter the grid
- [Reference: Grid State](/docs/reference/grid-state) - Full selection API
