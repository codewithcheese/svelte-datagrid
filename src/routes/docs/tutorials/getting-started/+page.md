...
- [Adding Selection](/docs/tutorials/adding-selection) - Select rows with clicks and keyboard
- [How-to: Filtering](/docs/how-to/filtering) - Add search and filters
- [Reference: DataGrid](/docs/reference/datagrid) - See all available props
