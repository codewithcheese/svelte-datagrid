...
- [Reference: Column Definition](/docs/reference/column-definition) - width, minWidth, maxWidth
- [Reference: Grid State](/docs/reference/grid-state) - setColumnWidth API
- [How-to: Theming](/docs/how-to/theming) - Style the resize handle
