...
|------|------|-------------|
| `data` | `TData[]` | Array of row data objects. Either `data` or `dataSource` must be provided. |
| `dataSource` | `DataSource<TData>` | Custom DataSource for server-side data. Either `data` or `dataSource` must be provided. |
...
- [Grid State](/docs/reference/grid-state) - State API
- [Tutorial: Getting Started](/docs/tutorials/getting-started) - Basic usage
