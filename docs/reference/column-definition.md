...
For complex rendering, use Svelte snippets (see [How-to: Custom Cells](../how-to/custom-cells.md)):
...
- [Reference: DataGrid](./datagrid.md) - Main component
- [Reference: Types](./types.md) - TypeScript definitions
- [How-to: Custom Cells](../how-to/custom-cells.md) - Advanced rendering
