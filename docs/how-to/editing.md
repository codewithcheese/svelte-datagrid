...
For server-side persistence, provide your own `MutableDataSource`:

```svelte
<script>
  import { DataGrid, createPostgresDataSource } from 'svelte-datagrid';
...
- [Reference: DataGrid](../reference/datagrid.md) - All DataGrid props
- [Reference: Column Definition](../reference/column-definition.md) - Column options
- [How-to: Keyboard Navigation](./keyboard-navigation.md) - Keyboard controls
