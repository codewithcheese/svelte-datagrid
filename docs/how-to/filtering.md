...
- [Reference: Grid State](../reference/grid-state.md) - Full filter API
- [Reference: Column Definition](../reference/column-definition.md) - Filter column options
- [Explanation: Performance](../explanation/performance.md) - Filter performance tips
